...
import { AiAnalysisFindManyArgs } from "../../aiAnalysis/base/AiAnalysisFindManyArgs";
...
export class TaskControllerBase {
  ...
  @common.Get("/:id/aiAnalyses")
  @ApiNestedQuery(AiAnalysisFindManyArgs)
  async findAiAnalyses(
    @common.Req() request: Request,
    @common.Param() params: TaskWhereUniqueInput
  ): Promise<AiAnalysis[]> {
    const query = plainToClass(AiAnalysisFindManyArgs, request.query);
    const results = await this.service.findAiAnalyses(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/aiAnalyses")
  async connectAiAnalyses(
    @common.Param() params: TaskWhereUniqueInput,
    @common.Body() body: AiAnalysisWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      aiAnalyses: {
        connect: body,
  ...
  @common.Patch("/:id/aiAnalyses")
  async updateAiAnalyses(
    @common.Param() params: TaskWhereUniqueInput,
    @common.Body() body: AiAnalysisWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/aiAnalyses")
  async disconnectAiAnalyses(
    @common.Param() params: TaskWhereUniqueInput,
    @common.Body() body: AiAnalysisWhereUniqueInput[]
  ): Promise<void> {
    const data = {
