...
@InputType()
class AiAnalysisCreateInput {
  @ApiProperty({
    required: false,
    type: () => EmailCreateNestedManyWithoutAiAnalysesInput,
  })
  @ValidateNested()
  @Type(() => EmailCreateNestedManyWithoutAiAnalysesInput)
  @IsOptional()
  @Field(() => EmailCreateNestedManyWithoutAiAnalysesInput, {
    nullable: true,
  })
...
export { AiAnalysisCreateInput as AiAnalysisCreateInput };
